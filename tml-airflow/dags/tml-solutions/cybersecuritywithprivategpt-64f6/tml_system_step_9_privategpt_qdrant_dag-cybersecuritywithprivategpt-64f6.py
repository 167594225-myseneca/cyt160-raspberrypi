...
default_args = {
 ...
 'pgptcontainername' : 'maadsdocker/tml-privategpt-no-gpu-amd64', #'maadsdocker/tml-privategpt-with-gpu-nvidia-amd64', #'maadsdocker/tml-privategpt-no-gpu-amd64',  # enter a valid container https://hub.docker.com/r/maadsdocker/tml-privategpt-no-gpu-amd64
 'rollbackoffset' : '10',  # <<< *** Change as needed
...
@dag(dag_id="tml_system_step_9_privategpt_qdrant_dag_cybersecuritywithprivategpt-64f6", default_args=default_args, tags=["tml_system_step_9_privategpt_qdrant_dag_cybersecuritywithprivategpt-64f6"], schedule=None,  catchup=False)
def startaiprocess():
    # Define tasks
    def empty():
        pass

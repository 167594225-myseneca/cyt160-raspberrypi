...
default_args = {
 ...
 'solutionname': 'cyt160proj02-4a57',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_cyt160proj02-4a57", default_args=default_args, tags=["tml_system_step_1_getparams_dag_cyt160proj02-4a57"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass

...
default_args = {
  ...
  'preprocesstypes' : 'preprocesstypes' : 'min,max,trend,anomprob,variance,avg', # <<< **** MAIN PREPROCESS TYPES CHNAGE AS NEEDED refer to https://tml-readthedocs.readthedocs.io/en/latest/
...
@dag(dag_id="tml_system_step_4_kafka_preprocess_dag_cybersecuritywithprivategpt-4a57", default_args=default_args, tags=["tml_system_step_4_kafka_preprocess_dag_cybersecuritywithprivategpt-4a57"], start_date=datetime(2023, 1, 1),schedule=None,catchup=False)
def startprocessing():
  def empty():
     pass
dag = startprocessing()

...
default_args = {
  ...
  'mqtt_broker' : '90c8f7a06b4c453b892654068f7e153d.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-4a57", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-4a57"], schedule=None,catchup=False)

...
default_args = {
 ...
 'companyname': 'Otics',  # <<< ********** You change as needed
  ...
  'preprocess_data_topic' : 'preprocess_data_topic' : 'cisco-network-preprocess', # Separate multiple topics with comma <<< ********** You change topic names as needed
...
@dag(dag_id="tml_system_step_2_kafka_createtopic_dag_cybersecuritywithprivategpt-4a57", default_args=default_args, tags=["tml_system_step_2_kafka_createtopic_dag_cybersecuritywithprivategpt-4a57"], start_date=datetime(2023, 1, 1), schedule=None,catchup=False)
def startkafkasetup():
    def empty():
        pass
dag = startkafkasetup()

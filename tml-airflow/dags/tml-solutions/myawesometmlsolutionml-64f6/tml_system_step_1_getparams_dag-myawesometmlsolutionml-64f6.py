...
default_args = {
 ...
 'solutionname': 'myawesometmlsolutionml-64f6',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolutionml-64f6", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolutionml-64f6"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass

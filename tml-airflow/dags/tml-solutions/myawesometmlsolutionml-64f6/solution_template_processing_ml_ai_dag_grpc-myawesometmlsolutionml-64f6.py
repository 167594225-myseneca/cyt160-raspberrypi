...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-64f6.tml_read_gRPC_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-64f6")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-myawesometmlsolutionml-64f6",

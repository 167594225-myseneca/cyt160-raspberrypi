...
step3 = importlib.import_module("tml-solutions.testproj02-4a57.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-testproj02-4a57")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-testproj02-4a57",
